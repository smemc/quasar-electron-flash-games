export default {
  ...
  description: [
    ...
    'Mas tome muito cuidado com as surpresas que podem aparecer pelo caminho!',
    'Vamos juntos participar dessa aventura!'
  ],
  url: 'http://www.brincandocomarie.com.br/arie-yuki-viloes/yuki_viloes.swf',
  width: 1280,
  height: 720,
  keywords: {
    language: ['Palavras']
